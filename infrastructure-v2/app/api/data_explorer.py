"""
Data Explorer API for POL Analytics.
...
async def update_lesson_numbers():
    ...
    try:
        ...
        cursor.execute("""
            ...
            WHERE extension_key = 'https://pol.com/lesson-number'
        ...
        cursor.execute("""
            ...
            WHERE ce.extension_key = 'https://pol.com/lesson-number'
        """)
