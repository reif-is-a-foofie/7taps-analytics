            ...
            statements = [
                {
                    "id": "statement-001",
                    "actor": {
                        "account": {"name": "user1@pol.com"}
                    },
                    "verb": {
                        "id": "http://adlnet.gov/expapi/verbs/completed"
                    },
                    "object": {
                        "id": "http://pol.com/activities/course-1",
                        "objectType": "Activity"
                    },
                ...
                },
                {
                    "id": "statement-002",
                    "actor": {
                        "account": {"name": "user2@pol.com"}
                    },
                    "verb": {
                        "id": "http://adlnet.gov/expapi/verbs/attempted"
                    },
                    "object": {
                        "id": "http://pol.com/activities/quiz-1",
                        "objectType": "Activity"
                    },
                ...
                },
                {
                    "id": "statement-003",
                    "actor": {
                        "account": {"name": "user3@pol.com"}
                    },
                    "verb": {
                        "id": "http://adlnet.gov/expapi/verbs/experienced"
                    },
                    "object": {
                        "id": "http://pol.com/activities/video-1",
                        "objectType": "Activity"
                    },
