...
class AdminPanelConfig:
    def __init__(self):
        self.sqlpad_url = os.getenv("SQLPAD_URL", os.getenv("DATABASE_TERMINAL_URL", "http://localhost:3000"))
        self.superset_url = os.getenv("SUPERSET_URL", os.getenv("DATABASE_TERMINAL_URL", "http://localhost:8088"))
