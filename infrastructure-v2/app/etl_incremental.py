...
# Global incremental processor instance (lazy-loaded)
_incremental_processor = None

def get_incremental_processor() -> IncrementalETLProcessor:
    """Get the global incremental processor instance (lazy-loaded)."""
    global _incremental_processor
    if _incremental_processor is None:
        _incremental_processor = IncrementalETLProcessor()
