...
# Global subscriber instance (lazy-loaded)
_subscriber = None

def get_subscriber() -> PubSubStorageSubscriber:
    """Get the global subscriber instance (lazy-loaded)."""
    global _subscriber
    if _subscriber is None:
        _subscriber = PubSubStorageSubscriber()
    return _subscriber
