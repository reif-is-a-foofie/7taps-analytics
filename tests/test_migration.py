...
class TestDataMigrationFix:
    ...
    async def test_current_data_state(self):
        ...
        async with httpx.AsyncClient() as client:
            ...
            assert flat_count > normalized_count, f"Migration issue: {flat_count} flat vs {normalized_count} normalized"
    ...
    async def test_database_table_structure(self):
        ...
        async with httpx.AsyncClient() as client:
            ...
            required_flat_columns = ["statement_id", "actor_id", "verb_id", "object_id", "raw_statement"]
            ...
            # Verify required columns exist
            required_normalized_columns = ["statement_id", "actor_id", "verb_id", "activity_id", "raw_statement"]
