...
class TestDataNormalizer:
        ...
        return {
            ...
            "object": {
                ...
                "definition": {
                    ...
                    "description": {
                        "en-US": "A test activity for validation"
                    },
    ...
    def test_extract_activity_data(self, normalizer, sample_statement):
        ...
        assert activity_data['activity_id'] == "https://example.com/activities/test-activity"
    ...
    def test_normalize_statement(self, normalizer, sample_statement):
        ...
        assert statement['activity_id'] == "https://example.com/activities/test-activity"
...
class TestDataNormalizationAPI:
    ...
    def test_normalize_statement_endpoint(self, sample_statement):
        ...
        response = client.post("/normalize/statement", json={
    ...
    def test_normalize_batch_endpoint(self, sample_statement):
        ...
        response = client.post("/normalize/batch", json={
            "statements": [sample_statement, sample_statement]
        })
