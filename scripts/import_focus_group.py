...
async def import_focus_group_data():
    ...
    try:
        ...
        csv_file = (
            ...
            / "All Response Data - Focus Group - Cleaned - All Response Data - Focus Group - Cleaned.csv"
        )
        ...
        response = requests.post(
            ...
            json={"csv_data": csv_data, "cohort_name": "focus_group_2024_immediate"},
            timeout=300,
        )
...
async def trigger_migration():
    ...
    try:
        ...
        response = requests.post(
            f"{HEROKU_URL}/api/migration/trigger", json={"force": True}, timeout=300
        )
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for cohort in result["cohorts"]:
                print(
                    f"   - {cohort['cohort_id']}: {cohort['total_learners']} learners, {cohort['total_responses']} responses"
                )
            return result
        else:
