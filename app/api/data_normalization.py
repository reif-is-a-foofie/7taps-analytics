...
async def setup_normalization_tables():
    ...
    try:
        ...
        return NormalizationResponse(
            success=True, message="Normalization tables created successfully"
        )
...
async def process_existing_statements(background_tasks: BackgroundTasks):
    ...
    try:
        ...
        return NormalizationResponse(
            success=True, message="Background processing of existing statements started"
        )
    ...
    try:
        ...
        return {
            ...
            "tables_available": len(
                [k for k, v in stats.items() if isinstance(v, int)]
            ),
