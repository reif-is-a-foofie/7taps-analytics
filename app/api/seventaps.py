...
# Import xAPI models
from app.models import xAPIIngestionResponse, xAPIStatement
...
def verify_webhook_secret(request_body: str, signature: str) -> bool:
    ...
    try:
        ...
        expected_signature = hmac.new(
            webhook_secret.encode(), request_body.encode(), hashlib.sha256
        ).hexdigest()
    ...
    try:
        auth_info = {
            ...
            "environment_variables": {
                ...
                "SEVENTAPS_WEBHOOK_SECRET": (
                    "configured" if os.getenv("SEVENTAPS_WEBHOOK_SECRET") else "not_set"
                ),
            },
