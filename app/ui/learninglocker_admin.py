...
class LearningLockerAdmin:
    ...
    def __init__(self):
        self.base_url = os.getenv(
            "LEARNINGLOCKER_URL",
            "https://seventaps-analytics-5135b3a0701a.herokuapp.com/learninglocker",
        )
...
async def get_sync_metrics():
    ...
    try:
        ...
        metrics = {
            "total_synced": sync_status.get("learninglocker_sync", {}).get(
                "total_synced", 0
            ),
            "last_sync_time": sync_status.get("learninglocker_sync", {}).get(
                "last_sync_time"
            ),
