...
class StatementBrowser:
    ...
    async def get_statements(
        ...
        try:
            ...
            statements = [
                {
                    "id": "statement-001",
                    "actor": {"account": {"name": "user1@7taps.com"}},
                    ...
                    "result": {"score": {"raw": 85, "min": 0, "max": 100}},
                },
                {
                    "id": "statement-002",
                    "actor": {"account": {"name": "user2@7taps.com"}},
                ...
                {
                    "id": "statement-003",
                    "actor": {"account": {"name": "user3@7taps.com"}},
            ...
            if search_query:
                ...
                statements = [
                    s for s in statements if search_lower in json.dumps(s).lower()
                ]
    ...
    async def get_statement_detail(self, statement_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            statement = {
                "id": statement_id,
                "actor": {"account": {"name": "user1@7taps.com"}, "name": "Test User"},
                "verb": {
...
async def statement_browser_page(
    request: Request,
